...
if __name__ == "__main__":
  ...
  # Get the current directoryDATA_DIR = r"D:\data\asvspoof\eval"      # Windows
  ...
  df.to_csv("D:/Pythonfile/Audio-Deepfake-Detection/data/feature/eval_intermediate_embedding_layer_"+str(intermediate_embedding_layer)+"_layer_index"+str(layer_index)+".csv", index = False)